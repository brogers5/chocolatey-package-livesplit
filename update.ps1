...
function global:au_AfterUpdate ($Package)  {
    $licenseUri = "https://raw.githubusercontent.com/$($softwareRepo)/$softwareTagPattern/LICENSE"
...
function global:au_SearchReplace {
    @{
        "$($Latest.PackageName).nuspec" = @{
            ...
            "<licenseUrl>[^<]*</licenseUrl>" = "<licenseUrl>https://github.com/$($softwareRepo)/blob/$($softwareTagPattern)/LICENSE</licenseUrl>"
            "<projectSourceUrl>[^<]*</projectSourceUrl>" = "<projectSourceUrl>https://github.com/$($softwareRepo)/tree/$($softwareTagPattern)</projectSourceUrl>"
            "<releaseNotes>[^<]*</releaseNotes>" = "<releaseNotes>https://github.com/$($softwareRepo)/releases/tag/$($softwareTagPattern)</releaseNotes>"
        ...
        'legal\VERIFICATION.txt' = @{
            ...
            '%tagReleaseUrl%' = "https://github.com/$($softwareRepo)/releases/tag/$($softwareTagPattern)"
